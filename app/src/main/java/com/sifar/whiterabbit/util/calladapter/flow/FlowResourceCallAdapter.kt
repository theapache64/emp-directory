package com.sifar.whiterabbit.util.calladapter.flow

import com.sifar.whiterabbit.util.calladapter.flow.Resource.Error
import com.sifar.whiterabbit.util.calladapter.flow.Resource.Success
